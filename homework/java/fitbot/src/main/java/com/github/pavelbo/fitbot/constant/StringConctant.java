...
public class StringConctant {
    ...
    public static final String SELECTION_OF_THE_HOUR = "Осталось выбрать планируемое время посещения. Уважаемые посетители, обращаем Ваше внимание в связи с пандемией, максимальное количество человек в одном зале - 15.";
